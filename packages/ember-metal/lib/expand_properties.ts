...
*/
export default function expandProperties(pattern: string, callback: (val: string) => void) {
  assert(
...
function dive(prefix: string, pattern: string, start: number, callback: (val: string) => void) {
